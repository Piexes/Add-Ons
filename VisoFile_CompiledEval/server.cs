...
function GameConnection::compEval(%cl,%str)
{
	...
	if($CompEval::Success) messageAll('',"\c7[\c4Compiled Eval\c7] \c7[\c2" @ %cl.getPlayerName() @ "\c7]\c5 --> \c6" @ %str);
	else messageAll('',"\c7[\c4Compiled Eval\c7] \c7[\c0" @ %cl.getPlayerName() @ "\c7]\c5 --> \c3" @ %str);
}
